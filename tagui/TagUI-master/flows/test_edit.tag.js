...
casper.then(function() {techo('wait 6');});
casper.then(function() {casper.wait(6000, function() {});});

// chọn ô A1
casper.then(function() {{techo('keyboard [ctrl] [home]'); var fs = require('fs');
if (!sikuli_step('keyboard [ctrl] [home]')) if (!fs.exists('[ctrl] [home]') && !false)
{this.echo('ERROR - cannot find image file [ctrl] [home]').exit(); this.wait(0);} else
{sikuli_step('snap page.png to D:/Tai_lieu_hoc/HK1Nam4/gd2/KDTM/BTH4/tagui/TagUI-master/flows/test_edit_error.png');
this.echo('ERROR - cannot find [ctrl] [home] on screen').exit(); this.wait(0);}}});

// bật chế độ nhập trong ô
casper.then(function() {{techo('keyboard F2'); var fs = require('fs');
if (!sikuli_step('keyboard F2')) if (!fs.exists('F2') && !false)
{this.echo('ERROR - cannot find image file F2').exit(); this.wait(0);} else
{sikuli_step('snap page.png to D:/Tai_lieu_hoc/HK1Nam4/gd2/KDTM/BTH4/tagui/TagUI-master/flows/test_edit_error.png');
this.echo('ERROR - cannot find F2 on screen').exit(); this.wait(0);}}});

// gõ nội dung
casper.then(function() {{techo('keyboard Kiem_tra_TagUI'); var fs = require('fs');
if (!sikuli_step('keyboard Kiem_tra_TagUI')) if (!fs.exists('Kiem_tra_TagUI') && !false)
{this.echo('ERROR - cannot find image file Kiem_tra_TagUI').exit(); this.wait(0);} else
{sikuli_step('snap page.png to D:/Tai_lieu_hoc/HK1Nam4/gd2/KDTM/BTH4/tagui/TagUI-master/flows/test_edit_error.png');
this.echo('ERROR - cannot find Kiem_tra_TagUI on screen').exit(); this.wait(0);}}});
...
casper.then(function() {this.echo('DONE');});
